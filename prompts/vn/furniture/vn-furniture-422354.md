...
source: https://www.tiktok.com/share/video/7674979472453422354
...
**Key visuals:** Warehouse · Folding Office Bed · Industrial LED Light · High Rack · Forklift · Metal Bracket · Mattress · Storage Pocket

## Prompt (English)
```text
[Style]: Realistic e-commerce sales style, with bright and clear visuals, clear and natural display of product details, and an enthusiastic, down-to-earth atmosphere.
[Environment]: Inside a large finished goods warehouse space, neatly arranged industrial ceiling lamps on the ceiling provide sufficient lighting, the floor is a smooth gray cement floor, multi-tier high racks filled with neatly stacked cartons are visible in the background, an orange forklift is parked in the distance, and dozens of identical gray folding nap beds are lined up neatly extending deep into the warehouse.
[Tone & Pacing]: The overall rhythm is fast and compact, the sales host speaks enthusiastically, energetically and infectiously, the camera switches smoothly and orderly, and all core selling points of the folding bed are efficiently conveyed through rapid connection of panoramic views, close-ups and demonstration shots.
[Camera]: A multi-dimensional lens combination is used: including a panoramic view showing the grand warehouse scene, a medium shot presenting the host interacting with the product, close-ups focusing on bed frame hardware, mattress fabric and other details, paired with partial slow-motion shots to highlight the soft texture of the mattress, with smooth follow shots and orbiting shots as the main camera movements.
[Lighting]: Multiple industrial LED ceiling lamps on the top of the warehouse provide uniform soft lighting across the entire area, with no obvious dark corners or harsh shadows. The light is bright and transparent, perfectly restoring the gray fabric texture of the folding bed and the industrial texture of the metal frame, ensuring the clarity and realism of the picture.
[Character]: East Asian woman aged 20-28, with fair and delicate skin, a clean face, a soft round oval face, relaxed eyebrows and eyes, wearing delicate light makeup, with a well-proportioned figure, dressed in a white short-sleeved POLO shirt and pure black slim-fit trousers, looking energetic, capable and professional. Her movements are natural and fluent throughout, with a bright, sincere smile and enthusiastic, full emotions.
...
Shot 4:
  ...
  - Scene: The female host stands back up next to the bed, smiles and raises her hand to continue introducing to the camera, with an endless expanse of neatly arranged identical folding beds in the background, highlighting that the product has sufficient stock.
  - Subject: Dài 1m8, không thép chịu lực lên tới 160kg này.
Shot 5:
...
Shot 7:
  ...
  - Scene: The female host stands next to the folding bed, naturally waves her arm to point at the vast array of folding beds behind her, continues to introduce enthusiastically, with the orange forklift and high racks in the background clearly visible, emphasizing the realism of in-stock warehouse products.
  - Subject: Các bạn ấn tay liền góc trái
Shot 8:
...
[Transition / Editing]:
- Using the smooth straight cut technique commonly used in e-commerce sales videos, transitioning naturally from the panoramic scene to detailed close-ups, connecting camera switches through action continuity, with no abrupt transitions throughout the process, the rhythm is compact and orderly, accurately guiding the audience's attention to focus on the core selling points of the product.
```
## 提示词（中文）
```text
[Style]: 写实电商带货风格，画面明亮通透，商品细节展现清晰自然，氛围热情接地气。
[Environment]: 大型成品仓储空间内，天花板排布整齐的工业吊顶灯提供充足照明，地面是光洁的灰色水泥地坪，背景可见多层高位货架堆满规整堆放的纸箱，远处停着一台橙色叉车，数十张同款灰色折叠午休床整齐列队延伸至仓库深处。
[Tone & Pacing]: 整体节奏明快紧凑，带货主播语气热情饱满、富有感染力，镜头切换流畅有序，通过全景、特写、演示画面的快速衔接，高效传递折叠床的各项核心卖点。
[Camera]: 运用多维度镜头组合：包含全景展示仓储盛况、中景呈现主播与产品互动、特写聚焦床架五金、床垫面料等细节，搭配局部慢镜头突出床垫柔软质感，运镜以平稳的跟拍和环绕拍摄为主。
[Lighting]: 采用仓库顶部多盏工业LED顶灯提供全域均匀柔光，无明显暗角与生硬阴影，光线明亮通透，完美还原折叠床的灰色布艺质感与金属架的工业质感，保障画面清晰度与真实度。
[Character]: 20-28岁东亚女性，皮肤白皙细腻面容干净，圆润鹅蛋脸眉眼舒展，化精致淡妆，身形匀称，身着白色短袖POLO衫搭配纯黑色修身长裤，活力干练专业，全程动作自然流畅，面带灿烂真诚笑容，情绪热情饱满。
...
Shot 4:
  - 时长: 9.5sec - 12.0sec
  - 镜头类型: 爆款销量佐证
  - 画面: 女主播站直身体回到床旁，面带笑容抬手向镜头继续介绍，背景是一望无际整齐排列的同款折叠床，凸显产品备货充足。
  - 口播: Dài 1m8, không thép chịu lực lên tới 160kg này.
Shot 5:
  - 时长: 12.0sec - 14.5sec
  - 镜头类型: 超值价格
...
Shot 7:
  - 时长: 19.5sec - 24.0sec
  - 镜头类型: 库存充足
  - 画面: 女主播站在折叠床旁，手臂自然挥动指向身后成片的折叠床阵列，继续热情讲解，背景的橙色叉车与高位货架清晰可见，突出仓储现货的真实感。
  - 口播: Các bạn ấn tay liền góc trái
Shot 8:
  - 时长: 24.0sec - 29.5sec
  - 镜头类型: 产品材质展示
...
[Transition / Editing]:
- 采用电商带货常用的流畅顺切手法，从全景场景自然过渡到细节特写，通过动作衔接镜头切换，全程无突兀转场，节奏紧凑有序，精准引导观众注意力聚焦产品核心卖点。
```
---
