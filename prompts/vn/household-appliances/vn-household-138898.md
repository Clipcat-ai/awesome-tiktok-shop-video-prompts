...
source: https://www.tiktok.com/share/video/7673896462954138898
...
**Key visuals:** Wooden Floor · Multi-layer Shelf · Mini Electric Hot Pot · Transparent Gift Box · Ceramic Plate · Woven Basket · Metal Bracelet

## Prompt (English)
```text
[Style]: Realistic e-commerce product promotion style, with soft warm lighting in the frame, clear and prominent product details, creating a warm and cozy home goods sharing atmosphere that fits the visual tone of local home goods short videos.
[Environment]: A modern home goods lifestyle store with abundant daylight, large floor-to-ceiling windows letting in soft natural light. The store features log-style decoration, light wood-colored flooring and ceiling paired with multi-layer shelves of the same color system. The shelves display ceramic tableware, woven storage baskets and other items, with tropical foliage plants dotted around, and multiple simple warm-toned chandeliers hanging from the ceiling. The overall atmosphere is neat and cozy.
[Tone & Pacing]: Authentic Vietnamese local e-commerce sales style, with an enthusiastic, straightforward and highly infectious introduction tone. The footage rotates slowly and steadily around the product for demonstration, with a relaxed and unhurried pace, and all visual focus remains firmly locked on the displayed mini electric hot pot product.
[Camera]: First-person handheld shooting perspective, 360-degree orbiting tracking shot centered on the product, keeping the product always in the absolute center of the frame. The camera stays stable throughout with no obvious shake, accurately presenting every detail of the product's packaging and appearance.
[Lighting]: Mixed soft light effect combining natural light from the window and the store's warm lamps. The light evenly illuminates the entire product without harsh shadows, the overall frame presents a warm and soft visual texture, perfectly highlighting the delicate texture of the electric hot pot's milky white matte body.
[Character]: 25-30 year old Asian woman, only her hands and part of her arms are visible. Her hand skin is delicate and smooth with slender, well-proportioned lines, her arm wears several thin metal bracelets, and a simple gold ring on her finger. She has a gentle and capable temperament, with steady and smooth movements, focused on demonstrating the product's appearance and packaging details.
...
[Transition / Editing]:
- A smooth image rotation transition is used between the two orbiting demonstration shots, keeping the visual focus of the frame always on the main product throughout, no extra transition effects. The editing rhythm matches the narration pace of the sales pitch, natural and fluid.
```
## 提示词（中文）
```text
[Style]: 写实电商带货风格，画面暖光柔和，产品细节清晰突出，营造出温馨治愈的家居好物分享氛围，符合本土家居好物短视频的视觉调性。
[Environment]: 白天采光充足的现代家居生活馆，大面玻璃窗透进柔和自然光，店内采用原木风装修，浅木色地板与吊顶搭配同色系多层置物架，货架陈列陶瓷餐具、编织收纳篮等物品，各处点缀热带观叶植物，顶部悬挂多盏简约暖光吊灯，整体氛围整洁温馨。
[Tone & Pacing]: 地道的越南本土电商带货风格，介绍语气热情直白充满感染力，画面围绕产品缓慢平稳旋转展示，节奏舒缓从容，所有视觉焦点始终牢牢锁定被展示的迷你电火锅产品。
[Camera]: 第一人称手持拍摄视角，以产品为中心进行360度环绕跟拍，保持产品始终处于画面绝对中心位置，镜头全程稳定无明显晃动，精准呈现产品包装与外观的每一处细节。
[Lighting]: 结合窗边自然光与店内暖光灯照明的混合柔光效果，光线均匀打亮产品全身，没有生硬的阴影，画面整体呈现出温暖柔和的视觉质感，完美凸显电火锅奶白色哑光机身的细腻质感。
[Character]: 25-30岁亚洲女性，仅露出手部与部分手臂，手部皮肤细腻光滑、线条纤细匀称，手臂佩戴多支细款金属手镯，手上佩戴一枚简约金戒指，气质温柔干练，动作沉稳流畅，专注展示产品外观与包装细节。
...
[Transition / Editing]:
- 两段环绕展示画面之间采用平滑的画面旋转过渡，全程保持画面视觉焦点始终在产品主体上，无多余转场特效，剪辑节奏贴合带货口播的讲述节奏，自然流畅。
```
---
