...
source: https://www.tiktok.com/share/video/7646015258443713799
creator: "@suni.kol"
...
## Prompt (English)
```text
[Style]: Warm, cozy home portrait aesthetic, with soft, bright pale color grading that highlights the exquisite texture of the pajama set, carrying a laid-back yet refined atmospheric vibe.
[Environment]: A retro residential space with soft, diffused lighting, fitted with light wood flooring. Roman columns, vintage wooden-framed doors and windows, wall-mounted decorative paintings, and recessed ceiling spotlights are visible in the background. A grey short-pile carpet covers the floor, creating an overall comfortable and relaxed atmosphere.
[Tone & Pacing]: Gentle, slow display rhythm, with the character's movements laid-back and natural, and smooth, steady camera motion that focuses on highlighting the pajama's cut and detailed design elements.
[Camera]: Primarily uses a fixed-position mirror selfie perspective, paired with eye-level and overhead flat-lay shots to showcase the laid-out clothing. The camera moves slowly and steadily with no unnecessary shaking.
[Lighting]: A combination of soft indoor top lighting and natural light from the window, casting evenly across the character and clothing, leaving soft sun shadows on the carpet. The overall lighting is bright and warm, with no harsh contrast between light and shadow.
[Character]: A 20-28 year old East Asian woman, with fair, smooth, naturally glowing skin and soft facial contours. She has voluminous deep brown long wavy hair, delicate defined facial features, a sheer natural no-makeup makeup look, a slender well-proportioned figure with slim limbs. She is wearing a white knitted camisole pajama set printed with bear patterns, with a gentle, laid-back temperament, soft slow movements, and a relaxed, content expression.
...
[Transition / Editing]:
- A subtle blurred dynamic transition is used on the mirror selfie shot to smoothly cut to the flat-lay display shot, then the same transition effect is used to cut back to the mirror selfie footage, creating a seamless flow that matches the slow, gentle video pace.
```
## 提示词（中文）
```text
[Style]: 温馨居家写真风，画面色调柔和白皙，呈现睡衣产品的精致质感，自带慵懒精致的氛围感。
[Environment]: 光线柔和通透的复古居家空间，铺设浅木色地板，背景可见罗马柱、复古木质框门窗、挂墙装饰画与嵌入式吊顶射灯，地面铺着灰色短绒地毯，整体氛围舒适松弛。
[Tone & Pacing]: 轻柔舒缓的展示节奏，人物动作慵懒自然，运镜流畅平稳，重点突出睡衣的版型与细节设计。
[Camera]: 以固定机位的对镜自拍视角为主，搭配平拍俯拍的平铺服装展示镜头，镜头移动缓慢平稳，无多余晃动。
[Lighting]: 柔和的室内顶光与窗边自然光结合，光线均匀地洒在人物与衣物上，在地毯上投下柔和的阳光阴影，整体光影通透温暖，没有生硬的明暗对比。
[Character]: 20-28岁东亚女性，皮肤白皙细腻通透有自然光泽，脸庞线条柔和，留蓬松深棕色大波浪长卷发，眉眼精致立体，清透伪素颜裸妆，身材匀称修长四肢纤细，身着印小熊图案的白色针织吊带睡衣套装，气质温柔慵懒，动作轻柔舒缓，神情放松惬意。
...
[Transition / Editing]:
- 对镜自拍画面使用轻微的模糊动态转场，自然衔接至平铺展示镜头，后续再以同样的转场效果切回对镜自拍画面，整体过渡流畅自然，贴合舒缓的视频节奏。
```
---
