...
source: https://www.tiktok.com/share/video/7679148959754980629
creator: "@diegoshopp1"
...
**Key visuals:** Panini Factory · Yellow Box · 2026 FIFA World Cup Logo · Conveyor Belt · Worker in Uniform · Orange Shopping Cart · Sticker Pack

## Prompt (English)
```text
[Style]: A realistic industrial-style short e-commerce video with clear, bright image quality, high color saturation, and highly visually impactful yellow brand elements.
[Environment]: Inside the Panini brand sports trading card sticker production workshop. It is daytime with full indoor artificial lighting that is bright and even. Multiple automated conveyor belts run through the space, workers in yellow work uniforms perform their tasks in an orderly manner, and large yellow signs printed with the red 'PANINI' logo hang from the ceiling, filling the space with a mass-production industrial atmosphere.
[Tone & Pacing]: A down-to-earth e-commerce sales presentation style. The host speaks in an enthusiastic, excited, highly infectious tone, with a fast, tight pace. They demonstrate the product while explaining in real time, using natural hand gestures to amplify the promotional expressiveness.
[Camera]: Fixed camera position shooting from a front eye-level angle, maintaining a medium shot framing throughout the entire video. The footage is stable with no unnecessary shaking, focusing on the on-camera host and the product in their hands to ensure the audience can clearly see product details as well as the host's facial expressions and movements.
[Lighting]: Full coverage from industrial overhead workshop lights. The light is even and bright, with no noticeable shadows on the host's face or the yellow product box in their hands. Colors are reproduced accurately and truthfully, and the overall illumination is bright, clean, and crisp.
[Character]: A 30-35 year old Latin American man with a healthy wheat-toned skin with natural texture, thick eyebrows and big eyes, a neat dark full beard, and sharp facial contours. He wears no makeup, has a well-proportioned, robust build with clearly defined forearm muscle lines, and is dressed in a form-fitting army green short-sleeve T-shirt and dark long trousers. He has an enthusiastic, talkative, and approachable demeanor, makes natural hand gestures as he speaks, and his emotional state transitions from surprised and regretful to excited and sincere.
...
[Transition / Editing]:
- Seamless, trace-free continuous editing. The entire video keeps the same fixed camera angle, and scene transitions are completed purely by capturing the natural changes in the host's facial expressions and movements. The pacing is smooth and fluid, meeting the straightforward, clear narrative requirements for short e-commerce videos.
```
## 提示词（中文）
```text
[Style]: 写实工业风电商短视频，画面质感清晰明亮，色彩饱和度高，黄色品牌元素视觉冲击力强。
[Environment]: 帕尼尼品牌球星卡贴纸生产车间内部，白天室内全人工照明，光线充足均匀，场内有多条自动化传送带，工人身着黄色工作服有序作业，高处悬挂印有红色“PANINI”标识的黄色大标牌，充满量产工业氛围。
[Tone & Pacing]: 地道接地气的电商带货风格，主播语气热情激动、充满感染力，节奏明快紧凑，边展示商品边实时讲解，搭配自然手势动作强化促销表现力。
[Camera]: 固定机位正面平视拍摄，全程保持中景取景，画面稳定无多余晃动，聚焦出镜主播与手中商品，确保观众清晰捕捉商品细节与主播的表情动作。
[Lighting]: 车间顶部的工业照明灯光全覆盖，光线均匀明亮，主播面部与手中黄色包装盒无明显阴影，色彩还原真实准确，整体光照通透干净。
[Character]: 30-35岁拉美男性，健康小麦色皮肤带自然纹理，浓眉大眼，留整齐深色络腮胡，面部轮廓立体，纯素颜无妆，身材匀称健壮小臂肌肉线条明显，身穿军绿色修身短袖T恤搭配深色长裤，气质热情健谈有亲和力，配合讲解自然做手势，情绪从惊讶惋惜过渡到兴奋诚恳。
...
[Transition / Editing]:
- 采用无痕迹连贯剪辑，全程保持同一固定机位画面，仅通过镜头捕捉主播表情与动作的自然变化完成段落过渡，节奏流畅丝滑，符合电商短视频直观清晰的叙事要求。
```
---
