...
source: https://www.tiktok.com/share/video/7666411820218879246
...
Shot 3:
  ...
  - Scene: The character changes into a burgundy slim-fit branded short-sleeve T-shirt, again using his left hand to lift the hem upwards to showcase the on-body effect of the burgundy T-shirt and the side brand marking. He stands tall, with the T-shirt fitting perfectly against his muscle lines. A fixed medium shot accurately captures the on-body cut details of the burgundy garment.
Shot 4:
  - Duration: 4.0sec - 9.0sec
  - Scene Type: Product material showcase
  - Scene: The character changes into a navy blue slim-fit branded short-sleeve T-shirt. First he grabs both sides of the collar with his two hands, pulling upwards to adjust the collar position. Then he runs both hands down the length of the garment from his abdomen to smooth out the fabric, before grabbing the T-shirt hem with both hands and gently pulling outwards to demonstrate the fabric's elasticity. The camera then slowly pushes in to a close-up of the chest, where the character uses the palm of his left hand to gently wipe the brand logo area on the chest, before the camera pulls back out to show the character's full body. The camera movement flows smoothly, moving from a wide shot gradually pushing in to a chest close-up then pulling back out to a medium shot.
Shot 5:
  - Duration: 9.0sec - 12.5sec
  - Scene Type: Outfit matching demonstration
  - Scene: The character is still wearing the navy blue slim-fit short-sleeve T-shirt, making small, confident rhythmic movements synced to the drum beats of the rap music. He rests both hands naturally at the waistband of his jeans, gently adjusting the position of the T-shirt hem to showcase the overall slim on-body effect of the T-shirt from multiple angles. Finally the camera pans slightly to the right, as the character gradually exits the frame from the left side. A subtle follow-cam movement matches the character's rhythmic motions, with the camera panning right at the end as the character moves fully out of view.
[Background Sound]:
- Highly energetic hip-hop/rap background music with prominent bass drum beats and a strong rhythmic tempo, styled as street/street culture/Black Hip-Hop/Gangsta Rap. It is fast-paced, loud, full of attitude and edge, featuring fast, aggressive English rap vocal samples that reinforce the atmosphere of 'attitude' and 'individuality', perfectly suited for short-form videos showcasing trendy men's outfits to attract young consumers who pursue uniqueness and fashion.
[Transition / Editing]:
- Fast cut transitions synced exactly to the drum beats of the background music, creating seamless, natural transitions between showcase shots of different colored T-shirts, before a final pan movement that reveals the full character. The entire editing rhythm aligns perfectly with the drum beats for intense visual dynamism.
```
## 提示词（中文）
```text
...
Shot 3:
  - 时长: 3.0sec - 4.0sec
  - 镜头类型: 穿搭搭配示范
  - 画面: 人物换上酒红色品牌修身短袖T恤，同样左手握住衣角向上轻提，展示酒红色T恤的上身效果与侧边品牌标识，身形挺拔，T恤完美贴合肌肉线条，固定中景镜头精准捕捉酒红色衣物的上身版型细节。
Shot 4:
  - 时长: 4.0sec - 9.0sec
  - 镜头类型: 产品材质展示
  - 画面: 人物换上藏蓝色品牌修身短袖T恤，先是双手分别抓住两侧衣领向上提拉调整领口位置，随后双手从腹部位置顺着衣身向下抚平面料，接着双手抓住T恤下摆轻轻向外拉扯展示面料弹性，随后镜头逐渐推进至胸部特写，人物用左手手掌轻柔擦拭胸口的品牌logo区域，最后镜头拉远回到人物全身画面，运镜从全景逐步推近至胸部特写再拉远回中景，顺滑流畅。
Shot 5:
  - 时长: 9.0sec - 12.5sec
  - 镜头类型: 穿搭搭配示范
  - 画面: 人物依旧穿着藏蓝色修身短袖T恤，配合rap音乐的鼓点自信做出小幅度的律动动作，双手自然放在牛仔裤腰侧，轻轻调整T恤下摆位置，多角度展示T恤上身的整体修身效果，最后镜头微微右移，人物逐渐从画面左侧离开，小幅跟拍运镜配合人物的律动动作，镜头最后向右平移，人物逐步移出画面。
[Background Sound]:
- 非常强劲的嘻哈/说唱背景音乐，带有明显低音鼓点和节奏感强烈的节拍，风格为街头/街头文化/黑人嘻哈（Hip-Hop/Gangsta Rap），节奏快、音量高、充满攻击性和态度感，歌曲中包含英文说唱人声采样，语速快、语气强硬，强化“态度”与“个性”氛围，适配潮流男装穿搭展示的短视频风格，吸引年轻追求个性与潮流的消费群体。
[Transition / Editing]:
- 采用随背景音乐鼓点快速切换的转场效果，不同颜色T恤的展示画面之间实现无缝自然过渡，最后利用镜头平移带出人物，全程剪辑节奏精准贴合鼓点，视觉动感强烈。
```
---
