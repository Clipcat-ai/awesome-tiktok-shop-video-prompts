...
source: https://www.tiktok.com/share/video/7668933667841936647
...
**Key visuals:** Light Beige Table · Women's Boxer Shorts · Knit Fabric · Waistband Logo · Manicured Hands · Russian Pop Music · Text Overlay
...
Shot 1:
  ...
  - Scene: Four pairs of women's boxer shorts are laid out neatly on the light beige desktop, in the colors khaki, black, white, and gray respectively. White text '4 pcs boxer shorts for women' is overlaid in the center of the frame. A pair of slender hands enters the frame from the top, gently pinches the branded waistband of the khaki pair of shorts with both hands, and slowly pulls it to both sides to fully demonstrate the elasticity of the waistband and the brand printed text on the waistband, with gentle and steady movements.
  - Subject: ПЕСНЯ
Shot 2:
  - Duration: 2.0sec - 5.0sec
  - Scene Type: Product material demonstration
  - Scene: The camera follows the hand movement to the white pair of shorts. Both hands pinch the waistband of the white shorts, gently lift the shorts up from the desktop, then pull the waist edges to both sides to show its excellent elasticity, then place the shorts back on the desktop and smooth it out gently, clearly demonstrating the overall cut of the white shorts and the drape of the fabric.
  - Subject: Кольцо с моим нимным
Shot 3:
  - Duration: 5.0sec - 7.5sec
  - Scene Type: Product material demonstration
  - Scene: Both hands move to the position of the gray pair of shorts. The palms first gently smooth the surface of the gray shorts to make the fabric flat and wrinkle-free, then both hands pinch the two sides of the shorts to lift it up gently, pull it to both sides to show the softness and elasticity of the fabric, shake it slightly, then place the shorts back on the desktop and arrange it neatly.
  - Subject: Поехали.
Shot 4:
  - Duration: 7.5sec - 10.0sec
  - Scene Type: Product design highlight demonstration
  - Scene: The hands move to the black pair of shorts. Both hands pinch the branded waistband of the black shorts, slowly pull it to both sides to show the elastic effect of the waist edge, the fingertips glide over the brand logo on the waistband to clearly show the printed details of the waist edge, then adjust the black shorts to a neatly laid flat state.
  - Subject: ПОДПИШИСЬ!
Shot 5:
...
[Transition / Editing]:
- Adopts coherent and smooth scene jump editing, using the natural movement of the hands to complete the switch between different colored pairs of shorts. There are no abrupt, awkward editing breaks throughout the process, and the footage connects naturally and seamlessly.
```
## 提示词（中文）
```text
...
Shot 1:
  - 时长: 0.0sec - 2.0sec
  - 镜头类型: 产品材质展示
  - 画面: 浅米色桌面上整齐平铺四条女式平角短裤，颜色分别为卡其色、黑色、白色、灰色，画面中间叠加白色文字“4 pcs boxer shorts for women”。一双纤细的手从画面上方伸入，双手轻轻捏住卡其色短裤的品牌腰头位置，向两侧慢慢拉扯，充分展示腰头的弹力和腰带上的品牌印刷字样，动作轻柔稳定。
  - 口播: ПЕСНЯ
Shot 2:
  - 时长: 2.0sec - 5.0sec
  - 镜头类型: 产品材质展示
  - 画面: 镜头跟随手部动作移动到白色短裤区域，双手捏住白色短裤的腰头，将短裤从桌面上轻轻提起，随后向两侧拉扯腰边展示出色的弹力，之后将短裤放回桌面轻轻抚平，清晰展示白色短裤的整体版型和面料垂坠感。
  - 口播: Кольцо с моим нимным
Shot 3:
  - 时长: 5.0sec - 7.5sec
  - 镜头类型: 产品材质展示
  - 画面: 双手移动到灰色短裤的位置，手掌先轻轻抚平灰色短裤的表面，让面料平整无褶皱，随后双手捏住短裤两侧将其轻轻拎起，向两侧拉扯展示面料的柔软度与弹力，晃动一下后再将短裤放回桌面摆放整齐。
  - 口播: Поехали.
Shot 4:
  - 时长: 7.5sec - 10.0sec
  - 镜头类型: 产品设计亮点
  - 画面: 手部移动到黑色短裤区域，双手捏住黑色短裤的品牌腰头，向两侧慢慢拉扯展示腰边的弹力效果，指尖划过腰带上的品牌标识，清晰展示腰边的印刷细节，随后将黑色短裤调整至整齐平铺的状态。
  - 口播: ПОДПИШИСЬ!
Shot 5:
  - 时长: 10.0sec - 12.0sec
  - 镜头类型: 展示多款式选择（时尚品类）
...
[Transition / Editing]:
- 采用连贯流畅的场景跳转剪辑，配合手部自然移动完成镜头在不同颜色短裤间的切换，全程无生硬突兀的剪辑断点，画面衔接自然顺滑。
```
---
