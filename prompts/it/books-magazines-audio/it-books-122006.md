...
source: https://www.tiktok.com/share/video/7678327390770122006
...
## Prompt (English)
```text
[Style]: Realistic product demonstration style, the frame focuses on the interaction details between the reading pen and the scripture, with a clean and clear texture, emphasizing the practical functions of the product.
[Environment]: A bright and soft indoor product display counter, the countertop is covered with a light-colored surface, and neatly arranged in the background are light yellow product packaging boxes printed with reading pen promotional patterns and Arabic text. On the countertop lie an open Quran with Arabic scriptures and the matching empty product box, the setup is neat and professional, forming a learning supplies display scene.
[Tone & Pacing]: Warm and natural product sharing tone, the rhythm is slow and steady, the camera moves forward slowly following the reading pen, meticulously demonstrating every operation detail.
[Camera]: First-person close-up perspective, the entire shot focuses on the interaction between the hand, the reading pen and the scripture, keeping the camera stable so that the audience can clearly see the whole process of the reading pen touching the scripture and producing sound.
[Lighting]: Even and bright indoor top light, the light is soft and not harsh, clearly illuminating the Arabic text on the scripture and the details of the reading pen, with no obvious shadows, ensuring all frame details are fully presented.
[Character]: Only the right hand of a woman wearing a thin bracelet is visible, the hand has a natural skin tone and smooth skin, with skillful and careful movements that show familiarity with operating the product, no face or full body appears in the frame.
...
[Transition / Editing]:
- Adopts a natural editing method that connects shots from the same camera position, the camera smoothly shifts the display focus following the movements of the reading pen, the entire frame stays focused on the product itself, the editing rhythm is steady and coherent, with no deliberate transition effects.
```
## 提示词（中文）
```text
[Style]: 写实产品展示风格，画面聚焦点读笔与经书的互动细节，质感干净清晰，着重体现产品的实用功能。
[Environment]: 光线明亮柔和的室内产品展示台，台面铺浅色桌面，背景整齐摆放印有点读笔宣传图案与阿拉伯文字的浅黄色产品包装盒，台面上放置打开的带阿拉伯经文的古兰经经书与配套空包装盒，布置整洁专业，是学习用品展示场景。
[Tone & Pacing]: 亲切自然的产品分享语气，节奏舒缓平稳，镜头随着点读笔的移动缓慢推进，细致展示每一项操作细节。
[Camera]: 第一人称近距离特写视角，全程聚焦手部、点读笔与经书的互动画面，保持镜头稳定，让观众清晰看到点读笔接触经文发声的全过程。
[Lighting]: 均匀明亮的室内顶光，光线柔和不刺眼，清晰照亮经书的阿拉伯文字与点读笔的细节，没有明显阴影，保证画面细节完整呈现。
[Character]: 仅露出佩戴细手链的女性右手，手部肤色自然，皮肤状态光滑，动作娴熟细致，展现出对产品操作的熟悉感，无面部与全身出镜。
...
[Transition / Editing]:
- 采用同机位镜头自然衔接的剪辑方式，镜头跟随点读笔的动作流畅切换展示重点，全程保持画面聚焦于产品本身，剪辑节奏平稳连贯，没有刻意的转场特效。
```
---
