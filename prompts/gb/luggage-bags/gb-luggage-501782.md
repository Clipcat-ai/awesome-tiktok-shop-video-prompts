...
source: https://www.tiktok.com/share/video/7611906383092501782
...
**Key visuals:** Black Long Coat · Surveillance Camera · Men's Wallet · RFID Card Reader · Wooden Table · Cash · Zip Pocket · Tiled Floor

## Prompt (English)
```text
[Style]: Realistic warning science popularization style. The first half restores the authentic black-and-white texture of surveillance footage, while the second half switches to a bright, clear product live-shooting style, balancing a sense of realism with the approachability of a good item recommendation.
[Environment]: The first half of the scene is set in a traditional Irish-style pub in October 2023, with wooden walls covered in vintage Guinness beer signs. Many drinking guests gather in front of the bar counter, and warm yellow indoor lighting creates a lively, relaxed pub atmosphere. The second half of the scene switches to an indoor bistro space with retro patterned tiles and wooden floors. The wooden tabletop is clean and tidy, with wooden dining chairs and a refrigerated display cabinet for wine arranged in the background, under bright and soft lighting.
[Tone & Pacing]: The first half restores the card skimming scenario at a slow, realistic pace to build a sense of warning. The second half shifts to a relaxed, natural rhythm, showing the details of the anti-scanning wallet in a genuine sharing tone, with a well-controlled overall pace that alternates between tension and ease.
[Camera]: The first half uses a fixed surveillance camera position that fully covers the pub bar area to authentically restore the on-site scene. The second half switches to a first-person handheld shooting perspective, paired with close-up macro lenses to show the wallet details. The camera moves naturally following the hand movements, with slight natural handheld shake.
[Lighting]: The surveillance footage in the first half has low-light black-and-white image quality, with even, flat lighting that fully restores the light and shadow details of the indoor scene. The second half uses a combination of bright, soft indoor top light and side light to clearly outline the leather texture of the wallet and the luster of its metal parts, with no harsh shadows.
[Character]: A 25-30 year old white female thief, acting cautiously and furtively, wearing a long black hooded coat for easy concealment. A 30-something white male science popularization blogger, with clear, flawless skin texture on his hands, dressed in casual, everyday outfits, with a friendly, down-to-earth temperament and a reliable sharing style.
...
[Transition / Editing]:
- A straight cut edit is used between the surveillance footage in the first half and the product live-shooting in the second half, creating a strong scene contrast that quickly transitions from the warning scenario to the solution demonstration, fitting the content rhythm logic of short videos.
```
## 提示词（中文）
```text
[Style]: 写实警示科普风，前半段还原监控录像的真实黑白质感，后半段切换为明亮清晰的产品实拍风格，兼具真实感与好物分享的亲和力。
[Environment]: 前半段场景位于2023年10月的一家爱尔兰风格传统酒吧，木质墙面挂满健力士啤酒复古标牌，吧台前聚集着不少饮酒的客人，暖黄色的室内灯光烘托出热闹松弛的酒吧氛围。后半段场景切换到铺有复古花纹瓷砖与木质地板的室内餐吧空间，木质桌面干净整洁，背景摆放着木质餐椅与陈列红酒的冷藏展示柜，光线明亮柔和。
[Tone & Pacing]: 前半段以缓慢写实的节奏还原盗刷场景，营造警示感，后半段节奏转为轻松自然，以真实分享的口吻展示防扫描钱包的细节，整体张弛有度。
[Camera]: 前半段采用固定监控机位，完整覆盖酒吧吧台区域，真实还原现场场景；后半段切换为第一人称手持拍摄视角，搭配特写微距镜头展示钱包细节，镜头随手部动作自然移动，带有轻微的自然手持晃动。
[Lighting]: 前半段监控画面为低照度黑白画质，光线均匀平实，完整还原室内场景的明暗细节；后半段采用明亮柔和的室内顶光与侧光组合，清晰勾勒钱包的皮革质感与金属部件光泽，无生硬阴影。
[Character]: 白人女性窃贼25-30岁，行动谨慎鬼祟，身着黑色长款连帽外套便于隐蔽；30岁左右白人男性科普博主，手部皮肤纹理清晰无瑕疵，穿搭日常随性，气质亲切务实，分享风格靠谱。
...
[Transition / Editing]:
- 前半段监控画面与后半段产品实拍采用直切跳转的剪辑方式，形成强烈的场景对比，快速从警示场景过渡到解决方案展示，符合短视频的内容节奏逻辑。
```
---
