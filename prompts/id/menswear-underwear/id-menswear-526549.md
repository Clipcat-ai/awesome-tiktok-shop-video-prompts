...
source: https://www.tiktok.com/share/video/7671585199817526549
...
**Key visuals:** Gym · Fitness Equipment · Wooden Table · Transparent Bag · Men's Boxer Shorts · Printed Waistband · Sewing Details · Dynamic Arrow
...
[Lighting]: Even soft lighting provided by multiple recessed ceiling lights in the gym, with no obvious harsh shadows, clearly outlining the fine fabric texture and soft colors of the underwear, the overall frame is bright and well-illuminated.
[Character]: 20-25 year old Southeast Asian woman with a healthy tanned skin tone, smooth delicate skin with a natural post-workout glowing finish, only part of her face and eyes are visible with soft, relaxed facial lines, wearing a sheer natural no-makeup athletic makeup look. She has a well-proportioned, toned figure, wears a tight-fitting solid black fitness yoga outfit, has a sunny, energetic and approachable temperament, moves smoothly and naturally, focuses entirely on demonstrating the selling points of the underwear throughout, with an expression that conveys the delighted feeling of sharing a great find.

[Shots]
Shot 1:
  - Duration: 0.0sec - 2.5sec
  - Scene Type: Set the usage scenario
  - Scene: In the bright gym setting, the Southeast Asian woman in black workout clothes stands next to the natural wood display table, holding up a transparent ziplock bag full of men's boxer briefs with both hands. She then releases her fingers gripping the bag, and the entire stack of underwear slides out of the bag and spreads out in a pile on the wood table. A downward-pointing yellow arrow indicator animation and corresponding text appear on the table at the same time.
  - Subject: Yang benar aja, masuk celana dalam bohong.
Shot 2:
  - Duration: 2.5sec - 6.5sec
  - Scene Type: Product material demonstration
  - Scene: The woman reaches into the pile of underwear, picks up a green pair of men's boxer briefs, gently flattens the waistband, and fully spreads out the wide waistband printed with the text 'HELLO' to display it to the camera. She then pinches both sides of the waistband with both hands and gently pulls it, intuitively showing the stretch elasticity of the waistband. The background shows clearly visible gym strength equipment, with bright lighting.
  - Subject: Boxer sebanyak ini harganya cuma Rp30.000an.
Shot 3:
  - Duration: 6.5sec - 9.0sec
  - Scene Type: Exceptional value pricing
  - Scene: The woman neatly aligns and stacks multiple pairs of men's boxer briefs in different colorways into a thick pile, holds the stacked underwear with both hands, and steadily displays the abundant quantity and neat cut of the full set of products in front of the gym equipment background. A downward-pointing arrow indicator animation and corresponding text appear at the bottom of the frame at the same time.
  - Subject: Sudah dapat 6 piece boxer, bahannya nyerepnya.
Shot 4:
...
Shot 6:
  ...
  - Scene: The camera switches to a close-up perspective, the fingertips of a pair of hands gently pinch the fabric at the pouch area of the men's boxer briefs, pull it slightly outward and hold the position to show the neat, dense stitching details on the inner side of the underwear, intuitively demonstrating the exquisite, fine workmanship.
...
Shot 8:
  ...
  - Scene: The woman's hands pick up the transparent plastic bag full of multi-color men's boxer briefs again, first show the neatly stacked multiple items inside the bag to the camera, then flip the bag over and pour all the underwear out onto the natural wood display table, creating a rich, scattered stacked visual effect. Finally, the woman reaches out, pinches the waistband of the yellow pair of underwear to show the details once more. A downward-pointing arrow indicator animation and guiding text keep appearing at the bottom of the frame.
  - Subject: Tunggu apa lagi? Buruan check out langsung di keranjang kiri belakangnya. bawah ya sebelum kehabisan.
[Background Sound]:
...
[Lighting]: 采用健身房顶部多盏嵌入式顶灯提供的均匀柔光照明，无明显生硬阴影，清晰勾勒出内裤面料的细腻质感与柔和色彩，整体画面光线明亮通透。
[Character]: 20-25岁东南亚女性，肤色健康小麦色，皮肤细腻光滑带运动后自然透亮感，仅露出部分脸部与眉眼，线条柔和舒展，清透运动伪素颜妆，身材匀称紧致，身着纯黑色修身健身瑜伽服，气质阳光活力亲和力强，动作流畅自然，全程专注展示内裤卖点，神情带着分享好物的惊喜感。

[Shots]
Shot 1:
  - 时长: 0.0sec - 2.5sec
  - 镜头类型: 设置使用场景
  - 画面: 明亮的健身房场景中，身着黑色健身服的东南亚女生站在原木展示台旁，双手共同托举拎着一个装满男士平角内裤的透明自封袋，随后她松开拎袋的手指，整袋内裤从袋中滑落，堆叠铺在原木台面上。台面上同步出现向下的黄色箭头指示动画与对应文字。
  - 口播: Yang benar aja, masuk celana dalam bohong.
Shot 2:
  - 时长: 2.5sec - 6.5sec
  - 镜头类型: 产品材质展示
  - 画面: 女生伸出手从堆叠的内裤里拿起一条绿色款男士平角内裤，轻轻展平腰头，将印有HELLO字样的宽腰头完全展开展示在镜头前，随后双手分别捏住腰头两侧轻轻拉扯，直观展现腰头的拉伸弹力。背景是清晰的健身房力量器械，光线明亮。
  - 口播: Boxer sebanyak ini harganya cuma Rp30.000an.
Shot 3:
  - 时长: 6.5sec - 9.0sec
  - 镜头类型: 超值价格
  - 画面: 女生将多款不同配色的男士平角内裤整齐对齐堆叠成厚厚的一摞，用双手托着摞起的内裤，在健身房器械背景前稳稳展示整组商品的丰富数量与规整版型。画面底部同步出现向下箭头指示动画与文字。
  - 口播: Sudah dapat 6 piece boxer, bahannya nyerepnya.
Shot 4:
  - 时长: 9.0sec - 12.5sec
  - 镜头类型: 产品有效性
...
Shot 6:
  - 时长: 15.5sec - 17.0sec
  - 镜头类型: 产品细节特写
  - 画面: 镜头切换为特写视角，一双手的指尖轻轻捏住男士平角内裤囊袋位置的面料，微微向外拉扯并停留展示，清晰露出内裤内侧工整细密的缝线细节，直观体现做工的精致考究。
...
Shot 8:
  - 时长: 19.0sec - 23.5sec
  - 镜头类型: 下单流程指引
  - 画面: 女生的双手再次拎起装满多色男士平角内裤的透明包装袋，先对着镜头展示袋内整齐码放的多件商品，随后翻转包装袋将所有内裤全部倒在原木展示台上，散落堆叠出丰富的视觉效果，最后女生伸出手捏住黄色内裤的腰头再次展示细节。画面底部持续出现向下箭头指示动画与引导文字。
  - 口播: Tunggu apa lagi? Buruan check out langsung di keranjang kiri belakangnya. bawah ya sebelum kehabisan.
[Background Sound]:
