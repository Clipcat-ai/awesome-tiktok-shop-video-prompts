...
source: https://www.tiktok.com/share/video/7676664996603907350
creator: "@buzzfakten"
...
**Key visuals:** Digital Store Shelf · Anker Power Bank · Brand Packaging Box · Blue Ambient Light · Knitted Sweater · USB-C Port · Power Level Screen · Hanging Rope
...
Shot 1:
  ...
  - Scene: The Caucasian female shopping guide stands in front of the store shelves, holding a dark gray power bank with a lanyard in her left hand. She extends her right index finger to point at the power bank in her hand, then lowers her right hand naturally before raising it again to make an emphasizing gesture. She leans slightly forward toward the camera with a bright, enthusiastic smile, while multiple displayed digital products and brand packaging boxes are clearly visible on the background shelves.
  - Subject: Freunde, aufgepasst! Heute ist der letzte Tag, an dem dieser verrückten
Shot 2:
  - Duration: 4.0sec - 10.0sec
  - Scene Type: Close-up product shot
  - Scene: The camera pushes in to a medium close-up. The woman holds the power bank up in front of the camera, clearly showing the lit battery level number indicator on the device's screen, while opening her right palm to assist with the explanation. The brand logo and lanyard details of the power bank are fully revealed, and the frame focuses on the product's screen display effect and exterior texture.
  - Subject: Ja. Ja. automatisch an.
[Background Sound]:
- Fast-paced, high-energy TikTok e-commerce promotional background music with a BPM of approximately 120-140, featuring electronic drum beats and synthesizer melodies. The volume is moderately high with a strong rhythmic sense, creating a sense of urgency and a promotional atmosphere that fits limited-time selling scenarios, effectively stimulating the audience's impulse to place orders immediately.
[Transition / Editing]:
- The scene size switch is completed naturally through a smooth camera push-in, with no abrupt jumps. The overall editing rhythm matches the smooth flow of the spoken sharing, keeping the visual focus of the frame steadily on the character and the product throughout.
```
## 提示词（中文）
```text
...
Shot 1:
  - 时长: 0.0sec - 4.0sec
  - 镜头类型: 限时优惠
  - 画面: 白人女导购站在门店货架前，左手握着带有挂绳的深灰色移动电源，右手伸出食指指向手中的移动电源，随后右手自然放下再抬起做手势强调，身体微微前倾靠近镜头，脸上带着灿烂热情的笑容，背景的货架上清晰展示着多款陈列的数码产品与品牌包装盒。
  - 口播: Freunde, aufgepasst! Heute ist der letzte Tag, an dem dieser verrückten
Shot 2:
  - 时长: 4.0sec - 10.0sec
  - 镜头类型: 产品镜头特写
  - 画面: 镜头推进至近景，女性将移动电源举到镜头前方，清晰展示设备屏幕上亮起的电量数字标识，同时摊开右手掌心辅助讲解，移动电源的品牌标识与挂绳细节完全展露，画面聚焦在产品的屏幕显示效果与外观质感上。
  - 口播: Ja. Ja. automatisch an.
[Background Sound]:
- 快节奏高能量的TikTok电商促销风背景音乐，BPM约120-140，带有电子鼓点和合成器旋律，音量中等偏高，节奏感强，营造出紧迫感与促销氛围，适配限时带货场景，有效激发观众即时下单冲动。
[Transition / Editing]:
- 采用顺滑的镜头推近自然完成景别切换，无生硬跳转，整体剪辑节奏贴合口播分享的流畅感，全程保持画面视觉焦点稳定在人物与产品之上。
```
---
