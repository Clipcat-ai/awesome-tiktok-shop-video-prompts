...
source: https://www.tiktok.com/share/video/7672393808205712648
creator: "@shra5447"
...
[Lighting]: Even and soft indoor top fill light, with no obvious hard shadows. It brightens the knitted fabric texture and color-blocking design of the bag. The overall picture is bright, clean and visually comfortable.
[Character]: 20-30 year old Asian woman, only her hands and part of her arms are visible. She has delicate hand skin, neatly manicured long nude-colored nail art, and slender arm lines. The visible arm is wearing a light pink fluffy sleeve, giving a soft, cute home-style vibe. Her temperament is gentle and meticulous, full of the warmth of a product sharer. Her hand movements are gentle and precise, focusing on demonstrating all features of the handbag throughout the process, conveying her love and recommendation for the product.
...
Shot 2:
  ...
  - Scene: A hand with nude-colored nail art holds a red-green-white color-blocked knitted handbag, slowly rotating the bag in front of the pegboard background on the white countertop, comprehensively showing the color-blocked appearance of the bag, the design details of the red woven handle and the metal ring buckle. The bag has a structured shape, and the knitted texture is clearly visible. The hand drives the bag to rotate slowly, the camera maintains fixed focus, clearly capturing the overall appearance of the bag throughout the process.
  - Subject: I'm lying down, just bouncing.
Shot 3:
  - Duration: 4.0sec - 7.0sec
  - Scene Type: Product versatility
  - Scene: Two hands wearing pink fluffy sleeves and with nude-colored nail art hold both sides of the bag, gently pulling the opening of the bag to both sides, fully showing the spacious inner space and fine knitted lining of the bag, then release the hands to let the bag naturally close back to its original state. The fixed close-up shot focuses on the opening area of the bag.
  - Subject: of the feeling inside out.
Shot 4:
  - Duration: 7.0sec - 12.0sec
  - Scene Type: Product capacity demonstration
  - Scene: Two hands with nude-colored nail art sequentially place three different styles of toiletry products into the handbag, arranging them side by side to fill the bottom of the bag, clearly demonstrating the ample storage space of the handbag. The camera is fixed and focused on the inner opening of the bag, slightly adjusting the focus following the hand movements of placing the items.
  - Subject: Change it to the feeling I know
Shot 5:
...
[Transition / Editing]:
- Chronological editing that matches the music drum beats. Each display segment connects naturally without abrupt cuts, progressing step by step from the product's appearance to its internal capacity and then to its material properties, which conforms to the user's cognitive logic of understanding the product.
```
## 提示词（中文）
```text
...
[Lighting]: 均匀柔和的室内顶置补光灯光线，无明显硬阴影，提亮包袋的针织面料纹理与拼色色彩，整体画面明亮干净，视觉舒适。
[Character]: 20-30岁亚洲女性，仅露出手部与部分手臂，手部皮肤细腻，修剪着干净整洁的裸色长美甲，手臂线条纤细，出镜手臂穿着浅粉色毛绒袖套，风格软萌居家，气质温柔细致，充满好物分享的亲切感，双手动作轻柔精准，全程专注展示手提包的各项特点，传递出对产品的喜爱与推荐感。
...
Shot 2:
  - 时长: 0.5sec - 4.0sec
  - 镜头类型: 产品材质展示
  - 画面: 一只做了裸色美甲的手拎着红绿白拼色的针织手提包，在白色置物台的洞洞板背景前缓慢转动包身，全方位展示包袋的拼色外观、红色编织手提带与金属圆环扣的设计细节，包身版型立挺，针织纹理清晰可见。手部带动包身缓慢旋转，镜头保持固定对焦，全程清晰捕捉包袋的整体外观。
  - 口播: I'm lying down, just bouncing.
Shot 3:
  - 时长: 4.0sec - 7.0sec
  - 镜头类型: 产品多功能性
  - 画面: 两只穿着粉色毛绒袖套、做了裸色美甲的手扶住包袋两侧，将包口向两侧轻轻拉开，充分展示包袋宽敞的内部空间与细密的针织内里，随后松手让包袋自然恢复闭合状态。固定特写镜头对焦包袋开口区域。
  - 口播: of the feeling inside out.
Shot 4:
  - 时长: 7.0sec - 12.0sec
  - 镜头类型: 产品有效性
  - 画面: 两只做了裸色美甲的手依次将三瓶不同款式的洗护用品放入手提包内，横向并排摆满包袋底部，清晰展示出手提包充足的容纳空间。镜头固定对焦包袋内部开口处，跟随手部放物品的动作轻微调整对焦。
  - 口播: Change it to the feeling I know
Shot 5:
  - 时长: 12.0sec - 18.0sec
  - 镜头类型: 产品使用场景
...
[Transition / Editing]:
- 采用贴合音乐鼓点的顺叙式剪辑，每一个展示环节自然衔接，无生硬跳切，从产品外观到内部容量再到材质特性循序渐进，符合用户了解商品的认知逻辑。
```
---
