...
source: https://www.tiktok.com/share/video/7667176021879246100
creator: "@_.pk7bnx_"
...
Shot 1:
  ...
  - Scene: Close-up shot showing the white plush doll hair clip worn on top of the head, the doll has a chubby cute shape, paired with simple silly little brown eyes and a small mouth, the doll's two 'little hands' wrap around a strand of hair that passes through from below, as if it is tightly grabbing the hair to climb up; the finger on the left side of the frame gently pinches another strand of hair, adjusting the hair into a playful shape that looks like the doll's 'antennae', vividly recreating the adorable dynamic of the doll clinging to the hair.
  - Subject: How do we have to live?
[Background Sound]:
- Upbeat TikTok electronic pop style background music, fast-paced with a loud volume, featuring strong drum beats and synth melodies, perfectly suited for the relaxed high-energy product promotion vibe of sharing creative trendy items for young audiences, lively and dynamic in style
[Transition / Editing]:
- No complex editing transitions throughout the entire video, using a fixed long take to keep continuous focus on the hair clip details, using natural and coherent footage to fully present the product's playful design and cute appearance
```
## 提示词（中文）
```text
...
Shot 1:
  - 时长: 0.0sec - 5.0sec
  - 镜头类型: 产品设计亮点
  - 画面: 近距离特写展示头顶佩戴的白色毛绒玩偶发夹，玩偶有着圆滚滚的可爱外形，搭配棕色的呆萌小眼睛和小嘴巴，玩偶的两只“小手”环抱住一缕从下方穿过的发丝，仿佛正紧紧抓着头发攀爬；画面左侧的手指轻轻捏住另一缕发丝，将发丝调整成类似玩偶“触角”的俏皮造型，生动还原玩偶抓着头发的萌趣动态。
  - 口播: How do we have to live?
[Background Sound]:
- 非常欢快的TikTok电子流行风格背景音乐，快节奏、音量较大，带有强烈鼓点和合成器旋律，适配年轻化创意好物分享的轻松高能量带货氛围，风格活泼动感
[Transition / Editing]:
- 全程无复杂剪辑转场，采用固定长镜头持续聚焦发夹细节，以自然连贯的画面完整呈现商品的趣味设计与可爱造型
```
---
