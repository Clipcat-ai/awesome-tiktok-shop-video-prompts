...
source: https://www.tiktok.com/share/video/7562851184000634130
...
## Prompt (English)
```text
[Style]: A down-to-earth, realistic short video sharing practical local Thai daily goods. The footage has a plain, approachable texture that fully restores the real scene of daily outdoor work, with no unnecessary fancy embellishments.
[Environment]: A private backyard outdoor space in the daytime with abundant natural light. A large-capacity blue water storage bucket is placed there, elevated by hollow bricks underneath. Half of the ground is a sandy gravel dirt road, while the other half is a worn cement step, with scattered dry fallen leaves. Next to the step sits an old small iron bucket with chipped paint along its rim.
[Tone & Pacing]: The overall rhythm is slow and natural, focusing entirely on the practical operation of pipe fitting installation. The narration pace matches the actual speed of the hand movements, giving viewers an intuitive feeling that the operation is practical, easy to understand, and simple to get started with.
[Camera]: The whole video mainly uses close-up and extreme close-up shots positioned very close to the shooting subject, with a small number of low-angle upward shots. The camera moves slowly to follow the hand movements, retaining the slight natural shake of handheld shooting to restore the authentic feel of a real demonstration recording.
[Lighting]: Filmed using natural diffused outdoor daylight. The light is even and soft with no harsh shadows, clearly illuminating the fine details of the hand operations, the structural texture of the pipe fittings, and the text on the surface of the water storage bucket, resulting in a natural and comfortable visual texture.
[Character]: An Asian male around 30 to 40 years old, with rough, slightly dark skin on his hands. Only the lower half of his face is visible, with a clear jawline. He is completely bare-faced, of medium sturdy build, wearing a navy blue long-sleeve top, blue washed jeans, and light gray closed-toe slippers. He has a plain, pragmatic temperament, with skilled, steady movements and a focused, engaged expression.
...
[Transition / Editing]:
- Natural scene transitions that follow the actions. The camera pans smoothly from the close-up of the installation on the side wall of the water storage bucket to the valve assembly process on the ground, and finally ends with a low-angle upward shot. The editing process fully follows the sequential order of the actual installation operation, with a smooth and natural rhythm.
```
## 提示词（中文）
```text
[Style]: 泰国本土实用好物分享写实短视频，画面质感质朴接地气，完全还原日常户外作业的真实场景，没有多余的华丽修饰。
[Environment]: 白天的户外自家后院场地，光线充足自然；摆放着大容量蓝色储水桶，下方用空心砖块垫高，地面一半是砂石土路、另一半是磨损水泥台阶，散落枯叶，台阶旁放着边缘掉漆的旧铁皮小桶。
[Tone & Pacing]: 整体节奏舒缓自然，全程围绕管件安装的实操动作展开，讲解节奏贴合手部操作的实际速度，给人实用、易懂、上手简单的直观感受。
[Camera]: 全程以贴近拍摄主体的近景、特写镜头为主，少量低角度仰拍，镜头随手部动作缓慢移动跟踪，保留轻微的手持拍摄自然晃动，还原真实演示记录感。
[Lighting]: 运用白天户外的自然散射光进行拍摄，光线均匀柔和，没有生硬的阴影，清晰照亮手部操作细节、管件的结构纹理以及储水桶表面的文字，画面质感自然舒适。
[Character]: 30-40岁左右亚洲男性，手部肌肤粗糙偏深，仅露出下半张脸、下颌线条清晰，完全素颜，体型中等结实，穿藏蓝色长袖上衣、蓝色水洗牛仔裤、浅灰色包头拖鞋，气质质朴务实，动作熟练沉稳，神态专注投入。
...
[Transition / Editing]:
- 采用场景跟随动作自然转场，镜头从储水桶侧壁的安装特写平稳摇移到地面的阀门组装环节，最后以低角度仰拍完成收尾，剪辑流程完全贴合安装实操的先后顺序，节奏流畅自然。
```
---
